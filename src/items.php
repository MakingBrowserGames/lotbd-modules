...
function items_getmoduleinfo()
{
    return [
        ...
        'version' => '0.0.1',
        'category' => 'Gameplay',
        'description' => 'Creates the central core for the items system.',
        'download' => 'nope',
        'prefs' => [
            'items' => 'Array of items in the inventory, viewonly| []',
            'in_use' => 'Array of items currently being used, viewonly| []'
        ]
    ];
}
