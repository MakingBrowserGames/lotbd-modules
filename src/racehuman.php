...
function racehuman_dohook($hookname,$args){
	...
	case "changesetting":
		...
		break;
	case "chooserace":
		output("`0<a href='newday.php?setrace=$race$resline'>On the plains in the city of %s</a>, the city of `&men`0; always following your father and looking up to his every move, until he sought out the `!Blue Dragon`0, never to be seen again.`n`n", $city, true);
